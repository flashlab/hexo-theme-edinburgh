AV.init({
  appId: '0jrYIvtvJPK734RFJ5APzlye-gzGzoHsz',
  appKey: 'Oz9OCoNaLejN8egcP38o09XA'
});
...
$(document).ready(function ()  { //.post-content 文章内页样式
  $(".col-lg-4").append("<div id='zan' class='clearfix'><div class='heart' onclick=\"goodplus('"+url+"')\"></div><div id='zan_text'></div></div>");
  senddata(url,flag);
